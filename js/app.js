(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".about-slider__slider")) new core(".about-slider__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 6,
            ...
            speed: 1e3,
            navigation: {
                prevEl: ".controls-about-slider__prev ",
                nextEl: ".controls-about-slider__next "
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".service-slider__slider")) new core(".service-slider__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".all-services__slider")) new core(".all-services__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
            ...
            loop: true,
            navigation: {
                nextEl: ".all-services__swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
